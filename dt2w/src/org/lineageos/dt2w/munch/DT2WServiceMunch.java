package org.lineageos.dt2w.Munch;
...
public class DT2WServiceMunch extends Service {
    private static final String TAG = "DT2WServiceMunch";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.munch.dt2w", dt2wEnabled ? "1" : "0");
        }
